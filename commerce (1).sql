...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 29 jan. 2020 à 21:00
...
ALTER TABLE `productentity`
  ...
  ADD CONSTRAINT `productentity_ibfk_2` FOREIGN KEY (`cartid`) REFERENCES `cart` (`id`);

--
-- Contraintes pour la table `receipt`
--
ALTER TABLE `receipt`
  ADD CONSTRAINT `FK_receiptcart` FOREIGN KEY (`cartid`) REFERENCES `cart` (`id`),
